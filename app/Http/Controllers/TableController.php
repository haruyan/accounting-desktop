...
class TableController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        return view('table.show',compact('entries', 'balances', 'faculties', 'faculty', 'table', 'months', 'years', 'year', 'fil_faculties', 'fil_b', 'fil_entries'));
    }


    public function printpdf($year,$faculty)
    {
        $entries = Entry::all();
        $balances = Balance::orderBy('year', 'asc')->get();
        $faculties = Faculty::all();
        ...
        $pdf = PDF::loadView('table.print', compact('entries', 'balances', 'faculties', 'faculty', 'table', 'months', 'years', 'year', 'fil_faculties', 'fil_b', 'fil_entries'))->setPaper('a4', 'landscape');
        return $pdf->download('laporan ' . $fil_faculties[0]->name . ' - ' . $year . '.pdf');
    }
}
