            ...
            {{-- @csrf                  --}}
	              ...
	              <div class="form-row">
	                ...
	                <div class="form-group col-md-6">
	                    ...
	                    <div class="input-group">
	                      ...
	                      <input type="text" class="form-control" id="amount" name="amount" placeholder="Nominal"  required="" value="{{ $entry->amount }}">
	                    </div>
	                </div>
	              </div>
	            ...
	            {{-- </form> --}}
	              ...
	              <div class="modal-footer">
	                <a href="{{ route('entries.index') }}" class=""><button type="button" class="btn btn-danger">Batal</button></a>
	                <a href="{{ route('entries.index') }}" class=""><button type="submit" class="btn btn-primary">Simpan Perubahan</button></a>
	              </div>
      	{!! Form::close() !!}
